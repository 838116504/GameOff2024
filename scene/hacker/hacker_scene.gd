...
func _on_input_name_popup_ok_btn_pressed(p_lastName, p_firstName, p_inputNamePopup):
	game_save.player_last_name = p_lastName
	game_save.player_last_name = p_firstName
